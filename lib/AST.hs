...
data Expression = SimpleExpression (Pos SumExpression)
                | RelationExpression (Pos RelationOperation)
                                     (Pos SumExpression)
                                     (Pos SumExpression)
...
data SumExpression = SimpleSumExpression (Pos ProductExpression)
                   | AdditionExpression (Pos AdditionOperation)
                                        (Pos SumExpression)
                                        (Pos ProductExpression)
data AdditionOperation = Add | Subtract | Or
data ProductExpression = SimpleProductExpression (Pos BasicExpression)
                       | MultiplicationExpression (Pos MultiplicationOperation)
                                                  (Pos ProductExpression)
                                                  (Pos BasicExpression)
